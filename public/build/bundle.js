...
var app = (function (crypto) {
    ...
    const file$5 = "node_modules/svelte-time/src/Time.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(time, file$5, 60, 0, 1479);
    		},
    ...
    function create_catch_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$4, 83, 8, 2837);
    		},
    		m: function mount(target, anchor) {
    ...
    // (75:49)              <h4>{decryptedMessage}
    function create_then_block$2(ctx) {
    	let h4;
    	let t0_value = /*decryptedMessage*/ ctx[7] + "";
    	let t0;
    	let t1;
    	let div;
    	let time_1;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$4, 75, 12, 2510);
    			attr_dev(div, "class", "post-footer svelte-5lgxi2");
    			add_location(div, file$4, 76, 12, 2550);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "then",
    		source: "(75:49)              <h4>{decryptedMessage}",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 79, 20, 2707);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			info.block.c();
    			add_location(blockquote, file$4, 73, 0, 2435);
    		},
    		l: function claim(nodes) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	async function requestAccess() {
    		...
    		const friendRes = await fetch(`https://getpantry.cloud/apiv1/pantry/3140d297-fd8e-4581-90f9-c879e38e26dd/basket/users`, {
    			method: 'GET',
    ...
    class Post extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { message: 4, time: 0, postOwnerID: 5 });
    ...
    const file$3 = "src/components/NewPost.svelte";
    ...
    function create_then_block$1(ctx) {
    	let if_block_anchor;
    	let if_block = /*user*/ ctx[5] !== null && create_if_block(ctx);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$3, 43, 8, 1283);
    			add_location(button, file$3, 44, 8, 1390);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 26, 2, 632);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Spinner extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { size: 0, color: 1, unit: 2 });
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a0, file$1, 18, 2, 438);
    			add_location(a1, file$1, 19, 2, 476);
    			add_location(nav, file$1, 17, 0, 430);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(a0, "click", /*handleLogin*/ ctx[0], false, false, false),
    					listen_dev(a1, "click", handleSignup, false, false, false)
    				];
    ...
    // (37:2) {#each posts.reverse() as post}
    function create_each_block(ctx) {
    	...
    	post = new Post({
    			props: {
    				...
    				postOwnerID: /*post*/ ctx[3].ownerID
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*posts*/ 1) post_changes.postOwnerID = /*post*/ ctx[3].ownerID;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(37:2) {#each posts.reverse() as post}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			info.block.c();
    			add_location(header, file, 27, 0, 750);
    			add_location(main, file, 30, 0, 778);
    		},
    		l: function claim(nodes) {
