...
var app = (function (crypto) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$2, 25, 0, 745);
    			add_location(button, file$2, 26, 0, 807);
    		},
    		l: function claim(nodes) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	async function handlePost() {
    		dist.ECCM.generateSharedKey(process.env.ECC_PRIVATE_KEY);
    		let encryptedMessage = dist.ECCM.encyrpt(message);
