...
var app = (function (crypto) {
    ...
    function decode$1(byteArray, offset = 0) {
    ...
    class ECCM {
        ...
        generateSharedKey(recipient) {
            this.ECC.generateSharedKey(recipient);
        }
        encrypt(plaintext) {
    ...
    function create_catch_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 85, 8, 2892);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_then_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$3, 77, 12, 2565);
    			attr_dev(div, "class", "post-footer svelte-5lgxi2");
    			add_location(div, file$3, 78, 12, 2605);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "then",
    		source: "(77:49)              <h4>{decryptedMessage}",
    		ctx
    	});
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$3, 81, 20, 2762);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			info.block.c();
    			add_location(blockquote, file$3, 75, 0, 2490);
    		},
    		l: function claim(nodes) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h5, file, 64, 2, 1944);
    			attr_dev(input, "placeholder", "enter your username");
    			set_style(input, "height", "50px");
    			set_style(input, "width", "588px");
    			add_location(input, file, 65, 2, 1969);
    			add_location(button, file, 66, 2, 2068);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(64:1) {#if cookieID === undefined}",
    		ctx
    	});
    ...
    // (76:3) {#each posts.reverse() as post}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(76:3) {#each posts.reverse() as post}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			if_block.c();
    			add_location(main, file, 62, 0, 1905);
    		},
    		l: function claim(nodes) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	async function handleLogin() {
    		if (api.get("uuid_ecc") === undefined) {
    			...
    			const res = await fetch(`https://getpantry.cloud/apiv1/pantry/3140d297-fd8e-4581-90f9-c879e38e26dd/basket/users`, {
    				method: 'PUT',
    				body: JSON.stringify({ [uuid]: { pub: key, friends: [] } }),
    				headers: { 'Content-Type': 'application/json' }
    			});
