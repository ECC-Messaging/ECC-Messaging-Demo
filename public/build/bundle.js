...
var app = (function (crypto) {
    ...
    class ECCInstance {
        ...
        generateSharedKey(othlicKPublicKey) {
    ...
    const user = asyncable(fetchUsers, null);
    async function fetchUsers() {
        const res = await fetch(`https://getpantry.cloud/apiv1/pantry/3140d297-fd8e-4581-90f9-c879e38e26dd/basket/users`, {
            method: "GET",
            headers: {
    ...
    async function fetchKeys() {
        const res = await fetch(`https://getpantry.cloud/apiv1/pantry/3140d297-fd8e-4581-90f9-c879e38e26dd/basket/serverkey`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json"
            }
    ...
    function create_catch_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 87, 8, 2945);
    		},
    		m: function mount(target, anchor) {
    ...
    // (79:49)              <h4>{decryptedMessage}
    function create_then_block$2(ctx) {
    	let h4;
    	let t0_value = /*decryptedMessage*/ ctx[10] + "";
    	let t0;
    	let t1;
    	let div;
    	let time_1;
    	...
    	let if_block = /*postEncrypted*/ ctx[1] && create_if_block$2(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$3, 79, 12, 2618);
    			attr_dev(div, "class", "post-footer svelte-5lgxi2");
    			add_location(div, file$3, 80, 12, 2658);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "then",
    		source: "(79:49)              <h4>{decryptedMessage}",
    		ctx
    	});
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$3, 83, 20, 2815);
    		},
    		m: function mount(target, anchor) {
    ...
    // (1:0) <script lang="ts">import Time from "svelte-time"; import ECCM from 'ecc-messaging-scheme-package'; import { user }
    function create_pending_block$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(1:0) <script lang=\\\"ts\\\">import Time from \\\"svelte-time\\\"; import ECCM from 'ecc-messaging-scheme-package'; import { user }",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			info.block.c();
    			add_location(blockquote, file$3, 77, 0, 2543);
    		},
    		l: function claim(nodes) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const friendRes = async () => {
    		const result = await fetch(`https://getpantry.cloud/apiv1/pantry/3140d297-fd8e-4581-90f9-c879e38e26dd/basket/users`, {
    			method: 'GET',
    	...
    	async function decryptMessage() {
    		if (userObject) {
    			if (userObject.uuid === postOwnerID) {
    				...
    				console.log(key);
    				const uuidECC = new _default(userObject.uuid);
    	...
    	return [time, postEncrypted, requestAccess, decryptPromise, message, postOwnerID];
    }

    class Post extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$3, create_fragment$3, safe_not_equal, { message: 4, time: 0, postOwnerID: 5 });
    		...
    		if (/*message*/ ctx[4] === undefined && !('message' in props)) {
    			console_1.warn("<Post> was created without expected prop 'message'");
    		}

    		if (/*time*/ ctx[0] === undefined && !('time' in props)) {
    			console_1.warn("<Post> was created without expected prop 'time'");
    		}

    		if (/*postOwnerID*/ ctx[5] === undefined && !('postOwnerID' in props)) {
    			console_1.warn("<Post> was created without expected prop 'postOwnerID'");
    		}
    	}
    ...
    // (1:0) <script lang="ts">import ECCM from 'ecc-messaging-scheme-package'; import { serverKey }
    function create_catch_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "catch",
    		source: "(1:0) <script lang=\\\"ts\\\">import ECCM from 'ecc-messaging-scheme-package'; import { serverKey }",
    		ctx
    	});
    ...
    function create_then_block$1(ctx) {
    	let if_block_anchor;
    	let if_block = /*user*/ ctx[5] !== null && create_if_block$1(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (/*user*/ ctx[5] !== null) if_block.p(ctx, dirty);
    		},
    		d: function destroy(detaching) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$2, 43, 8, 1283);
    			add_location(button, file$2, 44, 8, 1390);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	handle_promise(/*userPromise*/ ctx[2], info);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('userPromise' in $$props) $$invalidate(2, userPromise = $$props.userPromise);
    	};
    	...
    	return [message, handlePost, userPromise, input_input_handler];
    }
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h5, file, 63, 2, 1949);
    			attr_dev(input, "placeholder", "enter your username");
    			set_style(input, "height", "50px");
    			set_style(input, "width", "588px");
    			add_location(input, file, 64, 2, 1974);
    			add_location(button, file, 65, 2, 2073);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*handleLogin*/ ctx[4], { once: true }, false, false)
    				];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(63:1) {#if cookieID === undefined}",
    		ctx
    	});
    ...
    // (75:3) {#each posts.reverse() as post}
    function create_each_block(ctx) {
    	...
    	post = new Post({
    			props: {
    				message: /*post*/ ctx[8].message,
    				time: /*post*/ ctx[8].timestamp,
    				postOwnerID: /*post*/ ctx[8].ownerID
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const post_changes = {};
    			if (dirty & /*posts*/ 1) post_changes.message = /*post*/ ctx[8].message;
    			if (dirty & /*posts*/ 1) post_changes.time = /*post*/ ctx[8].timestamp;
    			if (dirty & /*posts*/ 1) post_changes.postOwnerID = /*post*/ ctx[8].ownerID;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(75:3) {#each posts.reverse() as post}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			if_block.c();
    			add_location(main, file, 61, 0, 1910);
    		},
    		l: function claim(nodes) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [posts, uuid, cookieID, promise, handleLogin, input_input_handler];
    }
