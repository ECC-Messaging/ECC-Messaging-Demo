...
var app = (function () {
    ...
    var BASE_URL = process.env.PANTRY_BASE_URL || 'https://getpantry.cloud';
    var VERSION = process.env.PANTRY_VERSION || 'apiv1';
    function fetch(url, method, data) {
        if (data === void 0) { data = {}; }
        url = [BASE_URL, VERSION, 'pantry', url].join('/');
        var headers = { 'Content-Type': 'application/json' };
        return new Promise(function (resolve, reject) {
            (0, axios_1.default)({ url: url, method: method, headers: headers, data: JSON.stringify(data) })
    ...
    var Pantry_1 = createCommonjsModule(function (module, exports) {
    ...
    var Pantry = /** @class */ (function () {
         ...
         */
        Pantry.prototype.getPantry = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, (0, fetch_1.fetch)(this.id, 'GET')];
                });
            });
        };
        /**
         ...
         */
        Pantry.prototype.postBasket = function (basketName) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.fetchBasket(basketName, 'POST')];
                });
            });
        };
        /**
         ...
         */
        Pantry.prototype.putBasket = function (basketName, data) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.fetchBasket(basketName, 'PUT', data)];
                });
            });
        };
        /**
         ...
         */
        Pantry.prototype.getBasket = function (basketName) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.fetchBasket(basketName, 'GET')];
                });
            });
        };
        /**
         ...
         */
        Pantry.prototype.deleteBasket = function (basketName) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.fetchBasket(basketName, 'DELETE')];
                });
            });
        };
        Pantry.prototype.fetchBasket = function (basketName, method, data) {
            if (data === void 0) { data = {}; }
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, (0, fetch_1.fetch)([this.id, 'basket', basketName].join('/'), method, data)];
                });
            });
        };
        return Pantry;
    ...
    var require$$0 = /*@__PURE__*/getAugmentedNamespace(Basket);

    var require$$1 = /*@__PURE__*/getAugmentedNamespace(Details);
    ...
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(11:16)   <Spinner/> {:then basket}",
    		ctx
    	});
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const pantry = new dist.Pantry(process.env.PANTRY_ID);

    	async function getBasket() {
    		await pantry.getBasket('testBasket');
    	}
